  ...
  return (
    <main className=" bg-gray-50">
      <section className=" min-h-screen  ">
        <BreadCrumb />
        <MaxWidthWrapper className=" grid gap-10 grid-cols-10  mt-5 justify-center">
          <div className="col-span-3">
            <div className="rounded-2xl border border-gray-400  bg-white flex flex-col py-10 px-3">
          ...
          <div className=" col-span-7 grid-cols-3">
            ...
            <MotionContainer className="sm:grid flex flex-col px-5  sm:grid-cols-2 lg:grid-cols-3 items-center gap-3 mt-[62px] justify-center">
