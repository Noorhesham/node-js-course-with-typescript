...
const SwiperCards = ({
  ...
  return (
    <div className="relative h-full gap-3 w-full flex flex-col">
      ...
      {btns && (
        <div className=" flex mb-4 items-center gap-20 flex-row-reverse  md:gap-10 justify-between lg:justify-center  mt-5 ">
          <Button
            onClick={() => swiper?.slidePrev()}
            className={`rounded-full flex-row-reverse flex px-6 py-4 items-center  border  border-main bg-white text-main duration-150 hover:text-white hover:bg-main `}
          >
