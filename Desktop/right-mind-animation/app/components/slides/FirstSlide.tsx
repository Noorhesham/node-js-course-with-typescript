    ...
    <section className=" absolute inset-0 w-full h-full ">
      <div className=" z-40">
        <Paragraph
          ...
          playAfterTL
          className="paragraph  bottom-auto top-64 md:bottom-64  md:top-auto lg:bottom-20 absolute left-10 lg:left-40 !text-7xl  z-40"
          text="Life style"
        />
        <Paragraph
          height={"h-8"}
          animate={animateParagraph}
          className="paragraph  top-[40%] max-w-xl lg:top-auto  lg:bottom-20 absolute right-10 lg:right-40 !text-xl   z-40"
