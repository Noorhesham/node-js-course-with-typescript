...
interface PreviewImageWallProps extends PreviewProps {
  images: { asset: { _ref: string } }[]
}

export const PreviewImageWall = (props: PreviewImageWallProps) => {
  const [galleryImageUrls, setGalleryImageUrls] = useState<string[]>([])
  const { renderDefault, images } = props
