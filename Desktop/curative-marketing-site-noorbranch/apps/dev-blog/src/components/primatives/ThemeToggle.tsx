...
export default function ThemeToggle() {
  ...
  return (
    <div className="relative z-0 inline-grid grid-cols-3 gap-0.5 rounded-full bg-gray-950/5 p-0.75 text-gray-950 dark:bg-white/10 dark:text-white" role="radiogroup">
      {/* System theme */}
      <span 
        className={`rounded-full p-1.5 *:size-7 sm:p-0 cursor-pointer ${
          theme === 'system' 
            ? 'bg-white ring inset-ring ring-gray-950/10 inset-ring-white/10 dark:bg-gray-700 dark:text-white dark:ring-transparent' 
            : ''
        }`}
